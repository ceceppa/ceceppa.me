...
use function Semplice\FrontEnd\get_post_date;
use function Semplice\SVG\the_svg;

?>
<header class="tile-header">
	<a href="<?php the_permalink(); ?>" class="tile-header__image flex flex--content-center" aria-label="<?php echo esc_attr( get_the_title() ); ?>">
